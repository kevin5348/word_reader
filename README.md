...
The system improves user language modeling accuracy with every session, using **Rasch modeling**, **Fisher information**, and a **custom regression word difficulty model** built from linguistic features.
